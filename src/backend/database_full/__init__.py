"""
CareForMe - Виртуальный сад TESTING_REPORT.md системой уровней и достижений.

Пакет для работы TESTING_REPORT.md базой данных виртуального сада.
Содержит репозитории, сервисы и API интерфейсы.

Основные возможности:
    - Система авторизации пользователей
    - Выращивание растений (Спатифиллум, Кактус, Фикус)
    - Система уровней TESTING_REPORT.md заданиями (1-5 уровни)
