"""
API интерфейс для работы TESTING_REPORT.md растениями.
...
class FlowerInterface:
    """
    Интерфейс для работы TESTING_REPORT.md растениями.

    Все методы этого класса предназначены для вызова из внешнего кода.
    Предоставляет упрощенный API для работы TESTING_REPORT.md растениями пользователя.
