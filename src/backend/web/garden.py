    ...
    plants = [
        {
            ...
            'care_tips': 'Полив раз DB_TESTING_REPORT.md 1-2 дня, любит рассеянный свет'
        },
        {
            'id': 2,
            'name': 'Кактус',
            ...
            'care_tips': 'Полив раз DB_TESTING_REPORT.md 7-10 дней, любит яркое солнце'
        },
        {
            'id': 3,
            'name': 'Фикус',
            ...
            'care_tips': 'Полив раз DB_TESTING_REPORT.md 3-4 дня, любит яркий рассеянный свет'
        }
    ]
